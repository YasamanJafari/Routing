...
def main(file_name):
    ...
    this_node.register_handlers(constant.TRACEROUTE_QUERY_PROTOCOL_NUM, this_node.handle_trace_route_query)
    this_node.register_handlers(constant.TRACEROUTE_RESPONSE_PROTOCOL_NUM, this_node.handle_trace_route_response)
